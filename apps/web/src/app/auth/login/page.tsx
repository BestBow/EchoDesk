      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border rounded-lg p-8 shadow-sm">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 border rounded-md py-2.5 px-4 text-sm font-medium hover:bg-accent transition-colors mb-4 disabled:opacity-50"
          >
            {googleLoading ? (
